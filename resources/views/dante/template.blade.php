...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        .page-id-15 #logo {
            background: transparent url('images/Dante_logo_white@2x.png') no-repeat center left;
        			...
        			<div class="header-wrap">
        				<div id="header-section" class="header-7 logo-fade">
        					<header id="header" class="clearfix">
                                <div id="top-header">
                                    <div class="container">
                                        <div class="th-left col-sm-6 clearfix">Contact us on 0800 123 4567 or info@dante.com</div> <!-- CLOSE .tb-left -->
                                            ...
                                            <ul class="menu">
                                                ...
                                                <li class="parent aux-languages">
                                                    ...
                                                    <ul id="header-languages" class="sub-menu">
                                                        ...
                                                        <li><div class="current-language"><span class="language name">English</span></div></li>
                                                ...
                                                <li class="parent shopping-bag-item">
        								            <a class="cart-contents" href="http://dante.swiftideas.net/cart/" title="View your shopping cart">
        								                <i class="ss-cart"></i>
        			                            ...
        			                            <li class="parent wishlist-item">
        			                                <a class="wishlist-link" href="http://dante.swiftideas.net/wishlist/" title="View your wishlist">
        			                                    <i class="ss-star"></i>
        			                                    <span>0</span>
                                                    </a>
                                                    <ul class="sub-menu"><li><div class="wishlist-bag"><div class="bag-header">My wishlist on Dante</div><div class="bag-contents"><div class="wishlist-empty">Your wishlist is currently empty.</div></div><div class="bag-buttons"><a class="sf-button standard sf-icon-reveal wishlist-button" href="http://dante.swiftideas.net/wishlist/"><i class="ss-star"></i><span class="text">Go to your wishlist</span></a></div></div></li></ul></li></ul>
                                            </nav>
        </div> <!-- CLOSE .tb-right -->
        </div> <!-- CLOSE .container -->
        </div><div id="undefined-sticky-wrapper" class="sticky-wrapper" style="height: 83px;"><div class="sticky-header">
    ...
    <div id="main-container" class="clearfix">
        ...
        <div id="footer-wrap">
            <section id="footer" class="footer-divider"><!--// OPEN #footer //-->
                <div class="container">
                    <div id="footer-widgets" class="row clearfix">
                        <div class="col-sm-3">
                            <section id="text-4" class="widget widget_text clearfix">
                                <div class="widget-heading clearfix"><h6>KEEP IN TOUCH</h6></div>
